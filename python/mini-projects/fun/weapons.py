...
class Weapon(object):
    """
        hit_types is dictionary with elemets like:
        {'hit_name' : ['damage_type', 'xdy+z']}
        This will add hit_name to hits type when player will atack,
        Exactly this will do from z + x to z + x*y damage, typed 'damage_type'
