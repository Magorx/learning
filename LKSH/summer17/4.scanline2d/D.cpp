...
std::vector<int32_t> compress(std::vector<int32_t> )
...
int main() {
    ...
    int32_t x_downleft = rectangles[0].downleft.x;
    int32_t y_downleft = rectangles[0].downleft.y;
    int32_t x_upright = rectangles[0].upright.x;
    int32_t y_upright = rectangles[0].upright.y;
